...
const Hero = () => {
	return (
		<div className="relative w-screen h-5/6">
			...
			<div className='relative flex flex-col md:items-center md:justify-center h-5/6 space-y-6'>
				<h1 className='text-2xl md:text-8xl text-primary'>Beachside Design</h1>
