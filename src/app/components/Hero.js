...
const Hero = () => {
	return (
		<div className="relative w-screen h-[600px] md:h-[860px]">
			<div className='-z-10 static'>
				<Image
					priority src={Heroimage} fill={true} alt="Beach Image"
					className="filter saturate-[.35] md:object-fill object-cover">
				</Image>
			</div>
			<div className='relative flex flex-col items-center
			justify-center w-full h-[600px] md:h-[860px] mx-auto'>
