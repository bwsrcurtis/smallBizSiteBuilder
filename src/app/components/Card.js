...
const Card = ({ src, alt, title, description }) => {
	...
	return (
		<div className='relative'>
			<div className='bg-primary/75 mx-auto invisible lg:visible xl:w-[20rem] h-96 w-[24rem] absolute top-[-.5rem] left-[-1rem] rounded-lg'></div>
			<div className='h-96 mx-auto xl:w-[20rem] w-[calc(full-2rem)] relative bg-secondary rounded-lg'>
