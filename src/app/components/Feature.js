const Feature = ({ title, description, Icon }) => {
  return (
    <>
      <div
        className='m-6 w-60 h-60 bg-text text-center rounded-3xl border-4 border-background
      justify-between flex flex-col items-center'>
        ...
        <div className='flex flex-col justify-between h-full w-full'>
          ...
          <div className='h-16 w-full bg-background border-4 border-background align-self-end rounded-b-2xl'>
